<template>
  <div class="login-container" v-if="showHideObj.showLoginTab">
    <a-row>
          ...
          <a-form :model="form" @submit="handleSubmit" @submit.prevent>
            ...
            <a-form-item>
              <div class="btn-container">
                ...
                <div class="btn-link" @click="forgetPassword()">忘记密码?</div>
              </div>
            </a-form-item>
          </a-form>
        </div>
  ...
  <div class="register-tab" v-if="showHideObj.showRegisterTab">
    <register v-on:back="handleRegisterBack"></register>
  </div>
</template>
<script>
  ...
  export default {
    ...
    methods: {
      ...
      goToRegister() {
        for (let key in this.showHideObj) {
          this.showHideObj[key] = false
        }
        this.showHideObj.showRegisterTab = true
      },
      handleRegisterBack(msg) {
        console.log(msg)
      },
    },
  }
