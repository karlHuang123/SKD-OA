...
const setting = {
  ...
  // 测试地址，后期会根据环境区分
  baseURL: 'http://47.102.125.150:8080',
  // process.env.NODE_ENV === 'development' ? 'http://47.102.125.150:8080' : 'http://47.102.125.150:8080',
  ...
  //pro版本copyright可随意修改
  copyright: 'Karl Huang karlhuang123@gmail.com',
  //缓存路由的最大数量
  keepAliveMaxNum: 99,
